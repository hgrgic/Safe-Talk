...
public class Encryptable {
    ...
    public static final String PUBLIC_KEY_LOCATION = FileManipulationUtility.pathBuilder(ROOT_KEY_LOCATION, "personal","public.key");
    public static final String PRIVATE_KEY_LOCATION = FileManipulationUtility.pathBuilder(ROOT_KEY_LOCATION, "personal","private.key");
